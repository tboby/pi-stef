...
2. If that process is stuck/abandoned, kill it (`kill 40957`) and I'll retry.
3. Tell me to retry in a moment if you expect that session to release the lock soon.
